...
const DataAllProvinces = {
  ...
  getDataAllProvinces: thunk(async (actions, payload) => {
    try {
      const config = {
        method: 'get',
        url: `https://cors-anywhere.herokuapp.com/${Endpoint.API_GET_ALL_PROVINCES}`,
        headers: {
...
export default DataAllProvinces
